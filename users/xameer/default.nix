{ lib, pkgs, flakeArgs, xameer-profiles, ... }:
{
  imports = [
    ./doom-emacs
    ./modern-unix.nix
    ./shells
    ./on-nixos
  ] ++ lib.optionals xameer-profiles.graphical [
    ./gui
  ];
  ...
  home.username = "xameer";
  home.homeDirectory = "/home/xameer";
  ...
  programs.git = {
    ...
    extraConfig = {
      ...
      gpg.format = "ssh";
      commit.gpgsign = true;
      user.signingkey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJZjpZ0wdmXwnVycJw8abOpspCbfWwDDm9WA8L/k9AID xameer_signing_2021-12-21";
